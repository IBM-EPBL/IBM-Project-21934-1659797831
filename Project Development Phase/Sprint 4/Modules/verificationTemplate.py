...
<body style="font-family: 'Fira Sans Condensed', sans-serif; color: black;">
    <center class="wrapper" data-link-color="#1188E6" data-body-style="font-size:14px; font-family:inherit; color:#000000; background-color:#f0f0f0;">
        ...
        <tbody>
            <tr>
                <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit;"  height="100%" valign="top"  role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #000; font-size: 15px">Thanks so much for joining Under the Customer Care Registry — we're thrilled to have you! Please Copy the Verification Code to complete your registration and set up your online profile. </span></div><div></div></div>
                </td>
            </tr>
        </tbody>
        </table>
